...
if(isset($_POST['add_product'])){
    ...
    // Prepare statement
    $insert_query = mysqli_prepare($conn, "INSERT INTO products (name, price, image, Product_Details) VALUES (?, ?, ?, ?)");
    mysqli_stmt_bind_param($insert_query, "sdss", $product_name, $product_price, $product_image, $product_details);
    ...
    <div class="container">
        ...
        <section>
            ...
            <form action="" class="add_product" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="product_details" placeholder="Enter product details" class="input_fields" required>
