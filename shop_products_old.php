    ...
    while($fetch_product=mysqli_fetch_assoc($select_products)){
     ...
     <form method="post" action="">
            <div class="edit_form">
                ...
                <input type ="submit" class="submit_btn cart_btn"  value ="Add to Cart" name="add to cart">
                <a href="view_product_details.php?id=<?php echo $fetch_product['id']?>" class="product_details_link">View Details</a>
